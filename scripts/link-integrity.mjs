 ...
 *
 * `content:graph` checks prerequisite ids inside the corpus and
 * `content:assets` checks binary assets; this gate separately proves that every
 * learner-facing `href` lands on a built file.
 *
