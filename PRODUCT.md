...
- 158 current lessons across eight ordered tracks, with English and pt-BR parity
  enforced at build time; the architecture anticipates later tracks and labs.
...
- Anonymous progress may be stored locally and synchronized only as constrained
  booleans. Teach-back prose never leaves the browser.
