...
quiz:
  - question: "Two tensors in the checkpoint have identical shape 248320×5120. What does their coexistence under different names prove?"
    options: ["The checkpoint is corrupted by duplication", "The model ties its embeddings to save memory", "The embeddings are untied: the input table and the lm_head are separate parameters of about 1.271B each", "The vocabulary is stored twice for speed"]
    correctIndex: 2
  ...
  - question: "In the minimal GPT you built last lesson, which module pair corresponds to these two 248320×5120 tensors?"
    options: ["the causal buffer and the optimizer state", "norm_attention and norm_ffn", "get_batch and generate", "token_embedding and language_head, which were also separate matrices"]
    correctIndex: 3
