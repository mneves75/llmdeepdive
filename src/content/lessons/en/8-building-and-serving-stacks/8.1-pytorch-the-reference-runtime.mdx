...
quiz:
  ...
  - question: "In the attention layers, what is the output width of the q_proj weight?"
    ...
    correctIndex: 0
    explanation: "attn_output_gate is set, so q_proj maps 5120 to 24 × 256 × 2 = 12288 and is chunked into a 6144 query and a 6144 gate. o_proj maps the 6144-wide gated attention output back to 5120; the 4 KV heads give 4 × 256 = 1024."
