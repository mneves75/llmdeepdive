...
Sampling is the second quiet failure. The complete current instruct preset is temperature 0.7, top_p 0.80, top_k 20, min_p 0, presence penalty 1.5, and repetition penalty 1.0. Thinking mode uses temperature 1.0, top_p 0.95, top_k 20, min_p 0, presence penalty 0, and repetition penalty 1.0. Framework support differs: set every supported field explicitly, record unsupported fields, and log the effective request — do not assume omitted defaults match the card.
