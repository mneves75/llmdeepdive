...
quiz:
  - question: "A workload sends 40 million input tokens and 10 million output tokens in a month. Using the Aug 2026 Workers AI prices for this model, what is the gross list-price cost before the daily free allocation, and which half dominates?"
    options: ["USD 22.50 total, since a blended rate applies to all 50 million tokens","USD 32.00 input plus USD 18.00 output, so USD 50.00 with input dominating","USD 160.00, since output tokens are billed at the input rate as well","USD 18.00 input plus USD 32.00 output, so USD 50.00 with output dominating despite being a fifth of the tokens"]
    correctIndex: 3
    explanation: "Before the daily free allocation, 40 million at USD 0.45 per million is USD 18.00 and 10 million at USD 3.20 per million is USD 32.00. Output is 20 percent of volume and 64 percent of this gross list-price cost; the actual invoice depends on daily traffic distribution."
