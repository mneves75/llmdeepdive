...
quiz:
  - question: "Which of these is a publishable fact about Qwen3.8-27B's pretraining data?"
    options: ["It was trained on 18 trillion tokens", "Its cutoff is March 2026", "None of them — no corpus composition, token count, or cutoff is published for this model", "Its mixture is 40 percent code"]
    correctIndex: 2
  ...
  - question: "Under the causal objective of lesson 5.1, why does one article mirrored on a thousand scraped sites distort training?"
    options: ["It changes the vocabulary size", "It disables the causal mask", "It converts the objective to MLM", "Its tokens receive a thousand times the next-token gradient of an equally informative unique article"]
    correctIndex: 3
