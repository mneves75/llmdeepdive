...
quiz:
  - question: "What should be checked before comparing throughput numbers across stacks?"
    options: ["Only the project name", "Only file size", "Whether logs use colors", "Same model, precision, decoding, lengths, concurrency, hardware, and correctness — and that each engine version supports the architecture at all"]
    correctIndex: 3
