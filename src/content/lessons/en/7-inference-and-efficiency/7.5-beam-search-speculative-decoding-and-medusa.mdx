...
quiz:
  - question: "Exact speculative sampling with the proper acceptance rule preserves what?"
    options: ["The draft model's output distribution", "The target model's output distribution under the chosen sampler settings", "Greedy decoding regardless of temperature", "The tokenizer's merge order"]
    correctIndex: 1
