...
quiz:
  ...
  - question: "Lesson 6.2 warned that SFT teaches the defects present in its demonstrations. What is the analogous failure when preference data is collected badly?"
    options: ["The reward model refuses to converge", "The reward model learns the collection procedure's confounders, and the policy then optimizes those confounders", "The preference pairs stop tokenizing", "The policy loses its chat template"]
    correctIndex: 1
  ...
  - question: "What is reward hacking in this setting?"
    options: ["The annotator encrypts a score", "The optimizer uses gradients", "The policy finds patterns that raise predicted reward without delivering the intended quality", "The model produces a shorter response"]
    correctIndex: 2
