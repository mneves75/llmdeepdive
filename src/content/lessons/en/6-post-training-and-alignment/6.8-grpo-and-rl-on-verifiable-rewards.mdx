...
summary: "Group-relative policy optimization compares sampled solutions within a prompt and shines when a program can check the outcome — the regime behind agentic coding scores like Qwen3.8-27B's vendor-reported SWE-bench Pro 61.7."
tier: "advanced"
locale: "en"
