...
summary: "Supervised fine-tuning teaches a pretrained model an interaction protocol; in Qwen3.8-27B the artifact it produces is a chat template with a thinking segment and a per-request switch to turn that segment off."
tier: "advanced"
locale: "en"
...
teachBack:
  prompt: "Describe the SFT objective, explain why only response tokens usually enter the loss, and say what concrete artifact SFT produced in Qwen3.8-27B."
