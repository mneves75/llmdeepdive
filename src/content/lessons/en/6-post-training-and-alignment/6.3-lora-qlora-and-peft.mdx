...
quiz:
  - question: "Which parameters are normally updated in LoRA training?"
    options: ["Every frozen base weight", "Only tokenizer vocabulary strings", "No parameters at all", "The small low-rank adapter matrices"]
    correctIndex: 3
  ...
  - question: "What is the defining extra step in QLoRA?"
    options: ["The adapters are removed before training", "The frozen base model is stored and used in quantized form while adapters train", "All computation becomes exact integer arithmetic", "The dataset is replaced by preference pairs"]
    correctIndex: 1
