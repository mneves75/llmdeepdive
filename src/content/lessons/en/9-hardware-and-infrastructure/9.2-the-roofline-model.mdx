...
quiz:
  - question: "A decode kernel achieves 0.3 percent of an H100's peak FLOPs. What does the roofline model conclude?"
    options: ["The kernel is badly written and needs better tensor-core usage","The GPU is faulty","Peak FLOPs was measured incorrectly","The kernel may already be at 100 percent of its attainable roofline; only raising arithmetic intensity or bandwidth can help"]
    correctIndex: 3
