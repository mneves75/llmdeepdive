...
quiz:
  ...
  - question: "A lição 6.11 descreveu destilação como treinar um modelo pequeno contra o comportamento de um grande. Por que essa é a técnica que sustenta a implantação na edge, e não um item desejável?"
    options: ["Ela comprime os mesmos 27B de pesos mais do que formatos de 4 bits conseguem","Ela muda a contagem de parâmetros, que é o termo que a quantização não consegue reduzir","Ela elimina a necessidade de uma toolchain de NPU","Ela elimina o KV cache"]
    correctIndex: 1
