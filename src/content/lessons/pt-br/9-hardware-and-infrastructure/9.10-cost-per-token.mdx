...
quiz:
  - question: "Aplicando a aritmética de orçamento da lição 9.3, por que o throughput anunciado de uma GPU alugada não se traduz diretamente num custo por token baixo?"
    options: ["Porque números de throughput sempre excluem o KV cache","Porque o vLLM cobra uma licença por token","Você aluga segundos, não tokens, então o preço efetivo é o aluguel fixo dividido pelos tokens que você de fato gera — a utilização decide","Porque pesos em bf16 custam mais caro para ler que pesos de 4 bits"]
    correctIndex: 2
  ...
  - question: "A lição 9.3 dimensionou um acelerador de 80 GB como 54 GB de pesos mais 64 KiB por token em cache. Por que essa aritmética pertence a um modelo de custo?"
    options: ["Porque memória é cobrada separadamente do compute","Porque ela determina o preço por milhão de entrada","Porque ela fixa o consumo elétrico","Porque ela limita as sequências concorrentes, o que limita o throughput atingível, que é o denominador do custo por token"]
    correctIndex: 3
