...
quiz:
  - question: "Um kernel de decode atinge 0,3 por cento do pico de FLOPs de uma H100. O que o modelo roofline conclui?"
    options: ["O kernel está mal escrito e precisa usar melhor os tensor cores","A GPU está com defeito","O pico de FLOPs foi medido de forma incorreta","O kernel pode já estar a 100 por cento do roofline atingível; só elevar a arithmetic intensity ou a bandwidth ajuda"]
    correctIndex: 3
