...
quiz:
  - question: "O Qwen3.8-27B tem dimensão de head 256 e partial_rotary_factor 0,25. Quantas dimensões por head o RoPE rotaciona?"
    options: ["256, todas elas", "128, exatamente metade", "16, a raiz quadrada de 256", "64, organizadas como 32 pares bidimensionais"]
    correctIndex: 3
    explanation: "256 × 0,25 = 64 dimensões rotacionadas, ou seja, 32 planos de rotação; as 192 dimensões restantes não são rotacionadas diretamente pelo RoPE, mas ainda podem conter features dependentes de posição."
  ...
  - question: "A quais tensores o RoPE é aplicado?"
    options: ["Apenas values", "Queries e keys", "Escalares de loss", "IDs de vocabulário depois da amostragem"]
    correctIndex: 1
