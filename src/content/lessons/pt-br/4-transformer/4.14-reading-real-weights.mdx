...
quiz:
  - question: "Dois tensores no checkpoint têm shape idêntico 248.320×5120. O que a coexistência deles sob nomes diferentes prova?"
    options: ["O checkpoint está corrompido por duplicação", "O modelo amarra seus embeddings para economizar memória", "Os embeddings não são amarrados: a tabela de entrada e o lm_head são parâmetros separados de cerca de 1,271B cada", "O vocabulário é armazenado duas vezes por velocidade"]
    correctIndex: 2
  ...
  - question: "No GPT mínimo que você construiu na lição anterior, qual par de módulos corresponde a esses dois tensores 248.320×5120?"
    options: ["o buffer causal e o estado do otimizador", "norm_attention e norm_ffn", "get_batch e generate", "token_embedding e language_head, que também eram matrizes separadas"]
    correctIndex: 3
  ...
  - question: "Você encontra q_proj com shape 12288×5120 e conclui que a conversão está quebrada, já que 24 heads × 256 dá 6144. Qual é o diagnóstico correto?"
    options: ["Nada está quebrado: estas camadas têm porta, então q_proj emite 24 × 256 × 2 = 12288, cada head ficando com 256 valores de query e depois 256 de porta", "O tensor está transposto e precisa ser corrigido para 5120×5120", "O arquivo confundiu q_proj com a FFN", "A head dimension precisa ser igual ao hidden size dividido pela contagem de heads"]
    correctIndex: 0
