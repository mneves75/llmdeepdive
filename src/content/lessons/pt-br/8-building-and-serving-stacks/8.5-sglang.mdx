...
quiz:
  - question: "Por que conteúdo volátil como um timestamp deve ficar no fim do prompt, e não no começo?"
    options: ["Timestamps confundem o tokenizer","O modelo lê prompts de trás para frente","Tokens tardios são cacheados, mas os iniciais não","O casamento de prefixo é exato e ancorado na posição um, então um token diferente logo no início significa que nenhum bloco é compartilhado"]
    correctIndex: 3
  ...
  - question: "O que o decoding restrito por gramática garante, e o que ele não garante?"
    options: ["Garante exatidão factual","Garante que a saída obedece ao schema, não que o conteúdo está correto ou bem raciocinado","Garante latência menor","Garante que o modelo usou thinking mode"]
    correctIndex: 1
