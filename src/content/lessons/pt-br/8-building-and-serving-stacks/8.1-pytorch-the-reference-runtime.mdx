...
quiz:
  ...
  - question: "Nas camadas de attention, qual é a largura de saída do peso q_proj?"
    ...
    correctIndex: 0
    explanation: "attn_output_gate está ligado, então q_proj mapeia 5120 para 24 × 256 × 2 = 12288 e é dividida em uma query de 6144 e uma porta de 6144. o_proj leva a saída de atenção de 6144, já escalada pela porta, de volta para 5120; os 4 KV heads dão 4 × 256 = 1024."
