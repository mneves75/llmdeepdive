...
quiz:
  - question: "Qual destes é um fato publicável sobre os dados de pretraining do Qwen3.8-27B?"
    options: ["Ele foi treinado em 18 trilhões de tokens", "Sua data de corte é março de 2026", "Nenhum deles — nenhuma composição de corpus, contagem de tokens ou data de corte é publicada para este modelo", "Sua mistura tem 40 por cento de código"]
    correctIndex: 2
  ...
  - question: "Sob o objetivo causal da lição 5.1, por que um artigo espelhado em mil sites raspados distorce o treino?"
    options: ["Ele muda o tamanho do vocabulário", "Ele desliga a máscara causal", "Ele converte o objetivo para MLM", "Seus tokens recebem mil vezes o gradiente de próximo token de um artigo único igualmente informativo"]
    correctIndex: 3
