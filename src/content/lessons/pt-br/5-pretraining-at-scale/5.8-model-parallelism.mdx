...
quiz:
  ...
  - question: "A lição 5.7 deixou cerca de 6,75 GB de estado persistente por rank sob ZeRO-3 em 64 ranks. Por que um time ainda poderia acrescentar tensor parallelism por cima?"
    options: ["Porque o ZeRO-3 não consegue shardear momentos do optimizer", "Shardear estado não sharda a computação de uma camada, então matrizes muito grandes e sequências longas ainda excedem o orçamento de compute e de ativações de um único rank", "Porque o tensor parallelism elimina a necessidade de gradientes", "Porque o FSDP exige um grupo de tensor parallel"]
    correctIndex: 1
  ...
  - question: "O que é uma bolha de pipeline?"
    options: ["Uma probabilidade de attention", "Um byte de fallback do tokenizer", "Tempo ocioso de estágio enquanto o pipeline enche, esvazia ou espera", "Um momento do optimizer"]
    correctIndex: 2
