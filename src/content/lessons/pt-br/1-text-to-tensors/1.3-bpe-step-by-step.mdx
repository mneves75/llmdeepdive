...
quiz:
  - question: "No corpus em que low aparece 5 vezes, lower 2 e lowest 3, o primeiro merge junta l e o. Qual é a contagem do par vencedor na segunda rodada?"
    options: ["3, para o par e seguido de s","10, para o par l seguido de o de novo","5, para o par lo seguido de w","10, para o par lo seguido de w"]
    correctIndex: 3
  ...
  - question: "Tokenizar o prompt de um usuário aprende merges novos?"
    options: ["Não, aplica os merges fixos aprendidos na ordem em que foram aprendidos","Só durante o fine-tuning","Só quando o prompt contém pontuação","Sim, para cada frase nova"]
    correctIndex: 0
  ...
  - question: "A lição 1.2 disse que o tokenizer do Qwen3.8-27B é byte-level. O que isso garante sobre o alfabeto base do BPE aqui?"
    options: ["O alfabeto base é aprendido junto com os merges","A base derivada de bytes representa todo byte UTF-8 de texto Unicode normalizado válido","Não existe alfabeto base, só pedaços fundidos","As unidades base são letras do inglês, então outras escritas precisam de um token desconhecido"]
    correctIndex: 1
    explanation: "O caminho ByteLevel+BPE publicado não precisa de token desconhecido para texto Unicode válido após normalização; strings incomuns ainda podem se expandir em muitos pedaços derivados de bytes."
citations:
