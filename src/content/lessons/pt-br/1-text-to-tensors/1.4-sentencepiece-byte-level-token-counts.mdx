...
quiz:
  - question: "Um prompt em inglês mede 18 tokens e sua tradução em português mede 26. Ao longo de um milhão de requisições a USD 0,45 por milhão de tokens de input, qual é o custo extra de input da versão em português?"
    options: ["USD 8,10","USD 0,45","USD 3,60","USD 11,70"]
    correctIndex: 2
  ...
  - question: "Qual é a única forma confiável de saber se um texto cabe na janela de contexto de um modelo?"
    options: ["Medir o tamanho em bytes do texto","Supor quatro caracteres por token","Contar as palavras e dividir por 0,75","Rodar o tokenizer exato que está em produção sobre a requisição totalmente montada, incluindo chat template e tokens especiais"]
    correctIndex: 3
  ...
  - question: "A lição 1.3 mostrou que os merges do BPE são aprendidos de um corpus em ordem de frequência. Por que isso explica contagens de tokens desiguais entre idiomas?"
    options: ["Pares frequentes no corpus de treino viraram pedaços únicos, então texto diferente daquele corpus é montado a partir de mais fragmentos","Porque texto fora do inglês é armazenado em outra codificação","Porque idiomas têm alfabetos diferentes","Porque palavras mais longas sempre custam mais tokens"]
    correctIndex: 0
...
citations:
  ...
  - title: "Qwen3.8-27B na Cloudflare Workers AI"
    authors: "Cloudflare"
    year: 2026
    url: "https://developers.cloudflare.com/workers-ai/models/qwen3.8-27b/"
