...
quiz:
  - question: "Qual é o papel do modelo de referência na DPO padrão?"
    options: ["Ele gera o alfabeto do tokenizer", "Ele fornece rótulos humanos automaticamente", "Ele ancora as mudanças relativas de log-probabilidade das respostas escolhida e rejeitada", "Ele elimina a necessidade de preference data"]
    correctIndex: 2
  ...
  - question: "A lição 6.4 descreveu comprimento como o confundidor canônico em preference data. Por que a DPO offline é especialmente exposta a ele?"
    options: ["Ela não consegue processar respostas mais longas que a janela de contexto", "Ela normaliza automaticamente toda resposta para o mesmo comprimento", "Ela descarta a resposta rejeitada antes de calcular a loss", "Ela pontua respostas inteiras pela log-probabilidade somada dos tokens, então diferenças de comprimento entram diretamente no objetivo e não há sampling novo para revelar a deriva"]
    correctIndex: 3
