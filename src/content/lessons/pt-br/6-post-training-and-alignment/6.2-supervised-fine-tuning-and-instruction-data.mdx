...
summary: "O supervised fine-tuning ensina a um modelo pré-treinado um protocolo de interação; no Qwen3.8-27B o artefato que ele produz é um chat template com um segmento de thinking e uma chave por requisição para desligar esse segmento."
tier: "advanced"
locale: "pt-br"
...
teachBack:
  prompt: "Descreva o objetivo do SFT, explique por que normalmente só os tokens de resposta entram na loss, e diga que artefato concreto o SFT produziu no Qwen3.8-27B."
