...
quiz:
  - question: "O que torna o SFT diferente do pretraining na prática?"
    options: ["Uma definição diferente de softmax", "Ausência de tokenização", "Dados curados de instrução-resposta e uma loss focada nas saídas desejadas", "Os pesos nunca são atualizados"]
    correctIndex: 2
  ...
  - question: "A lição 6.1 argumentou que um base model já possui a capacidade que parece faltar. O que decorre disso para o projeto de dados de SFT?"
    options: ["Só conjuntos de SFT muito grandes conseguem instalar qualquer comportamento", "O SFT precisa reensinar gramática e conhecimento de mundo do zero", "O checkpoint base precisa ser descartado antes do SFT", "Volume de exemplos de capacidade é a alavanca errada; as demonstrações precisam mostrar qual comportamento selecionar por padrão"]
    correctIndex: 3
