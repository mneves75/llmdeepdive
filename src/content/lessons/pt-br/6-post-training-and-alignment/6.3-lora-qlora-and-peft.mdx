...
quiz:
  - question: "Quais parâmetros normalmente são atualizados no treino com LoRA?"
    options: ["Todo peso base congelado", "Apenas as strings do vocabulário do tokenizer", "Nenhum parâmetro", "As pequenas matrizes de adapter de posto baixo"]
    correctIndex: 3
  ...
  - question: "Qual é o passo extra que define o QLoRA?"
    options: ["Os adapters são removidos antes do treino", "O modelo base congelado é armazenado e usado em forma quantizada enquanto os adapters treinam", "Toda a computação vira aritmética inteira exata", "O dataset é substituído por pares de preferência"]
    correctIndex: 1
