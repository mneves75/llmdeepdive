...
summary: "Quantization desce o Qwen3.8-27B a partir de 54 GB; artefatos de texto quase-4-bit fixados vão de 15,7 a 17,9 GB, com Q4_K_M em 17,1 GB, enquanto formatos de bits menores trocam mais qualidade por alcance."
tier: "advanced"
locale: "pt-br"
...
quiz:
  - question: "O que cria o erro de quantization?"
    options: ["Tokenização sozinha", "Arredondar valores para níveis discretos e fazer clipping de valores fora da faixa representada", "Mascaramento causal", "Streaming HTTP"]
    correctIndex: 1
  ...
  - question: "Usando a lição 7.3, por que quantization apenas de pesos ajuda mais o decode do que o prefill?"
    options: ["Prefill não faz multiplicações de matrizes", "Decode reexecuta a calibração a cada token", "Decode é limitado por largura de banda de memória ao ler os pesos a cada token, então encolher os bytes de peso ataca sua restrição dominante", "Quantization aumenta o throughput aritmético apenas do prefill"]
    correctIndex: 2
