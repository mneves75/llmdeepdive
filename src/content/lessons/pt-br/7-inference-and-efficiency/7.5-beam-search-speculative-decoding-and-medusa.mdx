...
quiz:
  - question: "O speculative sampling exato com a regra de aceitação apropriada preserva o quê?"
    options: ["A distribuição de saída do draft model", "A distribuição de saída do target model sob as configurações escolhidas do sampler", "Greedy decoding independentemente da temperature", "A ordem de merges do tokenizer"]
    correctIndex: 1
