...
summary: "Um mapa de decisão para escolher o engine que serve o Qwen3.8-27B — cada stack ganha depois sua própria lição na Trilha 8."
tier: "advanced"
locale: "pt-br"
...
quiz:
  - question: "O que deve ser verificado antes de comparar números de throughput entre stacks?"
    options: ["Só o nome do projeto", "Só o tamanho do arquivo", "Se os logs usam cores", "Mesmo modelo, precisão, decoding, comprimentos, concorrência, hardware e corretude — e que cada versão de engine suporte a arquitetura, para começar"]
    correctIndex: 3
...
| Stack | Recorra a ele quando | Lição da Trilha 8 |
| --- | --- | --- |
