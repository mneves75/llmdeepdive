...
teachBack:
  prompt: "Distinga GPTQ, AWQ, GGUF e QAT por papel, explique por que o GGUF Q4_K_M fixado do Qwen3.8-27B pesa 17,1 GB em vez do piso de 13,5 GB dos códigos puros, e diga por que converter entre formatos com perda não restaura qualidade."
...
quiz:
  ...
  - question: "Usando a lição 7.9, por que um tamanho de grupo menor pode melhorar a qualidade de uma quantization de 4 bits?"
    options: ["Grupos menores eliminam a necessidade de dados de calibração", "Grupos menores aumentam a largura de bits de cada peso", "O tamanho de grupo só afeta nomes de arquivo", "Cada grupo ganha sua própria escala, então um outlier deixa de tornar o passo mais grosseiro para um tensor inteiro"]
    correctIndex: 3
...
citations:
  ...
  - title: "Artefato GGUF Q4_K_M fixado do Qwen3.8-27B"
    authors: "Unsloth"
    year: 2026
    url: "https://huggingface.co/unsloth/Qwen3.8-27B-GGUF/blob/430473d9d0e975450ce1f445642b6527cb4faea1/Qwen3.8-27B-Q4_K_M.gguf"
updated: "2026-09-13"
---
